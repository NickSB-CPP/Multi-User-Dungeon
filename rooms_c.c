...
void setupRoomsC(Room dungeon[]) {
    ...
    dungeon[25].east = 26; dungeon[25].west = 24; dungeon[25].north = -1; dungeon[25].south = -1;

    dungeon[26].id = 26;
    dungeon[26].type = ROOM_TYPE_CONNECTOR;
    strcpy(dungeon[26].description, "The ground here trembles faintly. A secret may be nearby.");
    dungeon[26].east = 27; dungeon[26].west = 25; dungeon[26].north = -1; dungeon[26].south = -1;
    ...
    dungeon[29].id = 29;
    dungeon[29].type = ROOM_TYPE_CONNECTOR;
    strcpy(dungeon[29].description, "A spiral staircase descends into darkness. Its end cannot be seen.");
    dungeon[29].west = 28; dungeon[29].east = -1; dungeon[29].north = -1; dungeon[29].south = -2;
}
