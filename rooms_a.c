...
void setupRoomsA(Room dungeon[]) {
    ...
    dungeon[0].north = 1; dungeon[0].east = 2; dungeon[0].south = 3; dungeon[0].west = 4;
    ...
    dungeon[1].south = 0; dungeon[1].north = -1; dungeon[1].east = -1; dungeon[1].west = -1;
    ...
    dungeon[2].west = 0; dungeon[2].east = 5; dungeon[2].north = -1; dungeon[2].south = -1;
    ...
    dungeon[3].north = 0; dungeon[3].south = -1; dungeon[3].east = -1; dungeon[3].west = -1;
    ...
    dungeon[4].east = 0; dungeon[4].north = -1; dungeon[4].south = -1; dungeon[4].west = -1;
    ...
    dungeon[5].west = 2; dungeon[5].east = 6; dungeon[5].north = -1; dungeon[5].south = -1;
    ...
    dungeon[6].west = 5; dungeon[6].east = 7; dungeon[6].north = -1; dungeon[6].south = -1;
    ...
    dungeon[7].west = 6; dungeon[7].east = 8; dungeon[7].north = -1; dungeon[7].south = -1;
    ...
    dungeon[9].east = 1; dungeon[9].north = -1; dungeon[9].south = -1; dungeon[9].west = -1;
}
