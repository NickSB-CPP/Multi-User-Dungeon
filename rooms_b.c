...
void setupRoomsB(Room dungeon[]) {
    ...
    dungeon[10].east = 11; dungeon[10].west = 1; dungeon[10].north = -1; dungeon[10].south = -1;

    dungeon[11].id = 11;
    dungeon[11].type = ROOM_TYPE_NORMAL;
    strcpy(dungeon[11].description, "The hallway narrows, the walls lined with rusted pipes.");
    dungeon[11].west = 10; dungeon[11].east = 12; dungeon[11].north = -1; dungeon[11].south = -1;

    dungeon[12].id = 12;
    dungeon[12].type = ROOM_TYPE_NORMAL;
    strcpy(dungeon[12].description, "A narrow passage with debris scattered across the floor.");
    dungeon[12].west = 11; dungeon[12].east = 13; dungeon[12].north = -1; dungeon[12].south = -1;

    dungeon[13].id = 13;
    dungeon[13].type = ROOM_TYPE_NORMAL;
    strcpy(dungeon[13].description, "Storage room. Empty crates and broken lockers everywhere.");
    dungeon[13].west = 12; dungeon[13].east = 14; dungeon[13].north = -1; dungeon[13].south = -1;
    ...
    dungeon[14].west = 13; dungeon[14].east = 15; dungeon[14].north = -1; dungeon[14].south = -1;

    dungeon[15].id = 15;
    dungeon[15].type = ROOM_TYPE_NORMAL;
    strcpy(dungeon[15].description, "A room full of twisted machinery that hums faintly.");
    dungeon[15].west = 14; dungeon[15].east = 16; dungeon[15].north = -1; dungeon[15].south = -1;
    ...
    dungeon[18].west = 17; dungeon[18].east = 19; dungeon[18].north = -1; dungeon[18].south = -1;

    dungeon[19].id = 19;
    dungeon[19].type = ROOM_TYPE_CONNECTOR;
    strcpy(dungeon[19].description, "A steel hatch leads to an unknown destination. You sense it might go far.");
